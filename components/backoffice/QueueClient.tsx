...
import { QueueSummaryTable } from "@/components/backoffice/QueueSummaryTable"
...
export function QueueClient() {
  ...
  const [view, setView] = useState<"tarjetas" | "tabla">("tabla")
  ...
  return (
    <div className="bg-deep-ambient min-h-screen px-4 py-8 sm:px-6 lg:px-10">
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        ...
        {view === "tarjetas" && !loading && totalPages > 1 && (
